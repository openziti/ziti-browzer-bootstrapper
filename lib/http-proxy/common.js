...
common.logLevelGetForClient = function (client) {
  console.log('common.logLevelGetForClient entered for: ', client);
  let level = logLevelMap.get(client);
  console.log('common.logLevelGetForClient level is: ', level);
...
common.generateZitiConfig = function(url, client) {
  ...
  var ziti_sdk_js_loglevel = process.env.ZITI_SDK_JS_LOGLEVEL;
