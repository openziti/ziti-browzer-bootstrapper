...
// This is for *.browzer.cloudziti.io
const defaultOriginTrialToken = ``;

common.getOriginTrialToken = function() {

  var browzer_origin_trial_token = common.getConfigValue('ZITI_BROWZER_RUNTIME_ORIGIN_TRIAL_TOKEN')
  if (browzer_origin_trial_token && typeof browzer_origin_trial_token !== 'string') { throw new Error('ZITI_BROWZER_RUNTIME_ORIGIN_TRIAL_TOKEN value is not a string'); }
  if (!browzer_origin_trial_token) {
    browzer_origin_trial_token = `${defaultOriginTrialToken}`
  }
