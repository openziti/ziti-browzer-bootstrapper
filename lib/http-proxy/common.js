...
common.logLevelGetForClient = function (client) {
  ...
  if (typeof level === 'undefined') {
    level = process.env.ZITI_BROWZER_RUNTIME_LOGLEVEL;
  }
  return level;
};
...
common.generateZitiConfigObject = function(url, client) {
  ...
  var ziti_browzer_runtime_src = process.env.ZITI_BROWZER_RUNTIME_SRC;
  var idp_issuer_url = new URL( process.env.IDP_ISSUER_BASE_URL );
