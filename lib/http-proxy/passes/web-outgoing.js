...
module.exports = { // <--
  ...
  setRedirectHostRewrite: function setRedirectHostRewrite(req, res, proxyRes, options) {
    options.logger.debug('setRedirectHostRewrite() entered, options.hostRewrite [%s], proxyRes.headers [%o], proxyRes.statusCode [%o], proxyRes.headers[location] [%o], proxyRes.headers[Location] [%o]', 
      options.hostRewrite, 
      proxyRes.headers, 
      proxyRes.statusCode, 
