...
function withCORS(headers, request) {
    headers['access-control-allow-origin'] = common.generateAccessControlAllowOrigin(request);
...
corsProxy.getHandler = function getHandler(options, proxy) {
    ...
    return function(req, res, logger) {
      ...
      logger.silly('corsProxy handler entered for req.url [%o]', req.url);
      ...
      if (req.method === 'OPTIONS') {
        ...
        logger.silly('corsProxy handler method is OPTIONS');
